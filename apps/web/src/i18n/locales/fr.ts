...
export const FR_CATALOG: Catalog = {
  ...
  receive: {
    ...
    dropFilesFoldersHint: 'ou glissez-déposez des fichiers ou des dossiers ici',
    folderReadFailed: 'Impossible de lire ce dossier. Essayez de le sélectionner à nouveau.',
