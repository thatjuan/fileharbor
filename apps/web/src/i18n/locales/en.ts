export const EN_CATALOG = {
  ...
  receive: {
    ...
    dropFilesFoldersHint: 'or drag and drop files or folders here',
    folderReadFailed: 'This folder could not be read. Try selecting it again.',
    ...
    activePreparing: 'Preparing file {current} of {total}: {name}',
    activeUploading: 'Uploading file {current} of {total}: {name}',
    activeConfirming: 'Confirming file {current} of {total}: {name}',
    activeCancelling: 'Cancelling file {current} of {total}: {name}',
    batchProgress: '{completed} of {total} files completed',
    ...
    allUploadsComplete: 'All files were uploaded successfully.',
    reselectIncomplete:
      'Completed files were already received. Select only failed or unstarted files to try again.',
